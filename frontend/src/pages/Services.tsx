...
import { Calendar, Clock, User, IndianRupee, ArrowRight, Search } from 'lucide-react';
...
const serviceCategories = [
  {
    ...
    services: [
      ...
      },
      {
        ...
        provider: 'Kerala Ayurveda Centre',
        location: 'Kochi',
        duration: '90 min',
        price: 4500,
...
const ServicesPage = () => {
  ...
  const filteredServices = serviceCategories
    .find(category => category.id === activeCategory)?.services
    .filter(service => 
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-teal-500 to-teal-700 py-16">
